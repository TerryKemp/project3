...
class Indices extends React.Component{
    render(){
        ...
        if (this.props.value >= 3 && this.props.value <= 5.99) {
            ...
            p = <p>A UV Index reading of 3 to 5 means moderate risk of harm from unprotected sun exposure.
         ...
         if (this.props.value >= 6 && this.props.value <= 7.99) {
            ...
            p = <p>A UV Index reading of 6 to 7 means high risk of harm from unprotected sun exposure. Protection against skin and eye damage is needed.
            Reduce time in the sun between 10 a.m. and 4 p.m.
            If outdoors, seek shade and wear protective clothing, a wide-brimmed hat, and UV-blocking sunglasses.
            Generously apply broad spectrum SPF 30+ sunscreen every 2 hours, even on cloudy days, and after swimming or sweating. 
            Watch out for bright surfaces, like sand, water and snow, which reflect UV and increase exposure. </p>
         }
         if (this.props.value >= 8 && this.props.value <= 10.00) {
            button = <button className='red'> Very High </button>
            p = <p> A UV Index reading of 8 to 10 means very high risk of harm from unprotected sun exposure. Take extra precautions because unprotected skin and eyes will be damaged and can burn quickly.
         ...
         if (this.props.value >= 11) {
            ...
            p = <p> A UV Index reading of 11 or more means extreme risk of harm from unprotected sun exposure. Take all precautions because unprotected skin and eyes can burn in minutes. 
